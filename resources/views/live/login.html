...
<head>
	...
	<link rel="stylesheet" type="text/css" href="{{asset('css/live/reset.css')}}" />
	<link rel="stylesheet" type="text/css" href="{{asset('css/live/main.css')}}" />
	<link rel="stylesheet" href="{{asset('css/live/iconfont.css')}}">
